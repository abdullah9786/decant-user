    ...
    <article className="relative flex h-full min-h-[320px] flex-col overflow-hidden rounded-2xl border border-emerald-100 bg-[image:var(--accent-gradient)] text-[color:var(--accent-text)] shadow-sm">
      ...
      <div className="relative flex flex-1 flex-col p-5 md:p-6">
        ...
        <div className="mt-auto space-y-2 pt-5">
          <Link
            href="/products"
            className="group flex w-full items-center justify-center gap-2 rounded-lg bg-white py-3 text-[10px] font-bold uppercase tracking-widest text-emerald-950 transition-all hover:shadow-lg"
          >
            Start unlocking
            <ArrowRight size={13} className="transition-transform group-hover:translate-x-0.5" />
          </Link>
          <p className="text-center text-[10px] uppercase tracking-widest text-[color:var(--accent-muted)]">
            One gift per order
          </p>
        </div>
      </div>
