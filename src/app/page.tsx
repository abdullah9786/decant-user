          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div className="relative">
              ...
              <div className="relative grid grid-cols-2 gap-4">
                <div className="rounded-3xl overflow-hidden shadow-xl border border-emerald-50 relative aspect-[4/5]">
                  <Image
                ...
                <div className="rounded-3xl overflow-hidden shadow-xl border border-emerald-50 mt-10 relative aspect-[4/5]">
                  <Image
                    src="https://images.unsplash.com/photo-1519669011783-4eaa95fa1b7d?q=80&w=600&auto=format&fit=crop"
                    alt="Perfume details"
                    fill
                    sizes="(max-width: 1024px) 50vw, 25vw"
                    loading="lazy"
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-4xl md:text-5xl font-serif text-[color:var(--hero-text)] leading-tight">
                ...
                <br /> designed for obsession.
              </h2>
              <p className="text-[color:var(--hero-muted)] text-lg">
                We decant every fragrance by hand, preserving its character and
                clarity — so you can explore bold statements or intimate
                skinscents without the commitment of a full bottle.
              </p>
              <div className="grid grid-cols-2 gap-6 pt-2">
                {[
                  ...
                  <div
                    key={item.label}
                    className="p-4 bg-white/10 border border-white/10 rounded-2xl shadow-sm"
                  >
                    <div className="text-sm font-bold text-[color:var(--hero-text)]">
                      {item.value}
                    </div>
                    <div className="text-[10px] uppercase tracking-widest text-[color:var(--hero-muted)] mt-1">
                      {item.label}
                    </div>
                  </div>
                ))}
              ...
              <div className="flex items-center gap-4 pt-4">
                <Link
                  href="/new-arrivals"
                  className="bg-[color:var(--hero-cta-bg)] text-[color:var(--hero-cta-text)] px-8 py-3 text-xs font-bold uppercase tracking-widest hover:bg-[color:var(--hero-cta-bg-hover)] transition-all"
                >
                  Explore New Arrivals
                </Link>
                <Link
                  href="/brands"
                  className="text-xs font-bold uppercase tracking-widest text-[color:var(--hero-cta-alt-text)] border-b border-[color:var(--hero-cta-alt-border)]"
                >
                  Shop by Brand
                </Link>
              </div>
